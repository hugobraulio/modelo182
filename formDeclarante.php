<div id="formularioDeclarante" style="display: none; width:100%" class="center-container">
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input vvalue="2023" type="year" class="form-control" id="ejercicio" name="ejercicio" pattern="[0-9]{4}" min="2015" max="2099" maxlength="4" placeholder="ej:<?php echo Date("Y")?>" required>
    </div>
  </div>  
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input vvalue="31697511S" type="text" class="form-control" id="nif" name="nif" pattern="[0-9]{8}[A-Z]{1}" placeholder="ej:12345678Z" maxlength="8" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input vvalue="Fundación Dhamma Neru" type="text" class="form-control" id="denominacion" name="denominacion" placeholder="ej:Fundación XYZ" maxlength="40" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input vvalue="635824502" type="tel" class="form-control" id="telefono" name="telefono" pattern="[0-9]{9}" maxlength="9" placeholder="ej:654321987" required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-4">
      <input vvalue="Ana Lopez" type="text" class="form-control" id="persona" name="persona" maxlength="40" placeholder="ej:Antonio Pérez" required>
    </div>
  </div>
